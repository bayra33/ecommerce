    ...
    return (
        <header className="w-full h-[68px] bg-black flex justify-between items-center px-6">
            ...
            <div className="flex items-center gap-3">
               ...
               <Link href="/common"> <p className="text-white text-lg">Бүтээгдэхүүн</p> </Link>
            </div>
            ...
            <div className="flex items-center gap-3">
                ...
                <button className="px-4 py-2 border-2 rounded-lg text-white hover:bg-white hover:text-black transition-colors" type="submit">Бүртгүүлэх</button>
                <button className="px-4 py-2 border-2 rounded-lg text-white hover:bg-white hover:text-black transition-colors" type="submit">Нэвтрэх</button>
            </div>
        </header>
    );
};
